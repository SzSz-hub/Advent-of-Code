...
public class Day8A {
    ...
    private static final int CONNECTION_TO_MAKE = 1000;
    ...
    public static void createCircuit(){
        for (int i = 0; i < CONNECTION_TO_MAKE; i++) {
            JunctionBox boxA = allDistances.get(i).a;
            JunctionBox boxB = allDistances.get(i).b;
