...
public class Day7B {
    ...
    private static SortedMap<String, Integer> wires = new TreeMap<>();
    private static final int UNSIGNED_SHORT_MASK = 0xFFFF; // 65535
    private static List<String> parseLater = new ArrayList<>();
    private static final List<String> allParsing = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        // store a value in ba value and empty the rest.
        int temp = getWireValue("a");
        wires = new TreeMap<>();
        wires.put("b", temp);
        parseLater = allParsing;
