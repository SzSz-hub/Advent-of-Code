...
public class Day9B {
    ...
    private static int shortestTravel(List<travel> travels, HashSet<String> travelSet) {
        ...
        for(String cityA: travelSet) {
            ...
            int distance = travelDistance(travels, 0, cityA, remainingCities, longestDistance);
    ...
    private static int travelDistance(List<travel> travels, int currentDistance, String currentCity, HashSet<String> remainingCities, int longestDistance) {
        ...
        for (String city : remainingCities) {
            for (travel t : travels) {
                if (t.involvesCity(currentCity) && t.involvesCity(city)) {
                    ...
                    int distance = travelDistance(travels, currentDistance + t.distance, city, newRemainingCities, longestDistance);
                    if (distance > longestDistance) {
                        longestDistance = distance;
                    }
                }
